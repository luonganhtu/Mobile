...
namespace BusinessLogicLayer.CategoryLocalhost {
    ...
    public partial class CategoryService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SelectNameCategoryOperationCompleted;
        
        private System.Threading.SendOrPostCallback SelectIdCategoryOperationCompleted;
        ...
        /// <remarks/>
        public event SelectNameCategoryCompletedEventHandler SelectNameCategoryCompleted;
        
        /// <remarks/>
        public event SelectIdCategoryCompletedEventHandler SelectIdCategoryCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://CategoryService.org/DeleteCategory", RequestNamespace="http://CategoryService.org/", ResponseNamespace="http://CategoryService.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void DeleteCategoryAsync(int pCategoryID) {
            this.DeleteCategoryAsync(pCategoryID, null);
        }
        
        /// <remarks/>
        public void DeleteCategoryAsync(int pCategoryID, object userState) {
            ...
            this.InvokeAsync("DeleteCategory", new object[] {
                        pCategoryID}, this.DeleteCategoryOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://CategoryService.org/SelectNameCategory", RequestNamespace="http://CategoryService.org/", ResponseNamespace="http://CategoryService.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SelectNameCategory(int pCategoryID) {
            object[] results = this.Invoke("SelectNameCategory", new object[] {
                        pCategoryID});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void SelectNameCategoryAsync(int pCategoryID) {
            this.SelectNameCategoryAsync(pCategoryID, null);
        }
        
        /// <remarks/>
        public void SelectNameCategoryAsync(int pCategoryID, object userState) {
            if ((this.SelectNameCategoryOperationCompleted == null)) {
                this.SelectNameCategoryOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSelectNameCategoryOperationCompleted);
            }
            this.InvokeAsync("SelectNameCategory", new object[] {
                        pCategoryID}, this.SelectNameCategoryOperationCompleted, userState);
        }
        
        private void OnSelectNameCategoryOperationCompleted(object arg) {
            if ((this.SelectNameCategoryCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SelectNameCategoryCompleted(this, new SelectNameCategoryCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://CategoryService.org/SelectIdCategory", RequestNamespace="http://CategoryService.org/", ResponseNamespace="http://CategoryService.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int SelectIdCategory(string pCategoryName) {
            object[] results = this.Invoke("SelectIdCategory", new object[] {
                        pCategoryName});
            return ((int)(results[0]));
        }
        
        /// <remarks/>
        public void SelectIdCategoryAsync(string pCategoryName) {
            this.SelectIdCategoryAsync(pCategoryName, null);
        }
        
        /// <remarks/>
        public void SelectIdCategoryAsync(string pCategoryName, object userState) {
            if ((this.SelectIdCategoryOperationCompleted == null)) {
                this.SelectIdCategoryOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSelectIdCategoryOperationCompleted);
            }
            this.InvokeAsync("SelectIdCategory", new object[] {
                        pCategoryName}, this.SelectIdCategoryOperationCompleted, userState);
        }
        
        private void OnSelectIdCategoryOperationCompleted(object arg) {
            if ((this.SelectIdCategoryCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SelectIdCategoryCompleted(this, new SelectIdCategoryCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void SelectNameCategoryCompletedEventHandler(object sender, SelectNameCategoryCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SelectNameCategoryCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SelectNameCategoryCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void SelectIdCategoryCompletedEventHandler(object sender, SelectIdCategoryCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SelectIdCategoryCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SelectIdCategoryCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
